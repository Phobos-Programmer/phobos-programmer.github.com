    ...
    talents: {
      ...
      "Solar Plexus Impact": {
        ...
        description: talentText`The energy of the Kidney Shot strike reaches the solar plexus. Each time you use Kidney Shot ability you have ${[
          10,
          20,
        ]}% per Combo Point to apply Garrote effect and refresh Expose Armor duration. Additional effects take place even if target is immune to stun effects.`,
      },
      "Seal Fate": {
        name: "Seal Fate",
        pos: "f2",
      ...
      "Master Poisoner": {
        ...
        description: talentText`Each time when you apply poison to your target with ${[
          ...
          80,
          100,
        ]}% you additionally do an extra Chaos Poison damage {attack power * 0.2} which ignores any resistance or immunity.`,
      },
      "Mutilate": {
        name: "Mutilate",
        pos: "f4",
      ...
      Vigor: {
        ...
        maxRank: 1,
        reqPoints: 30,
        description: talentText`Increases your maximum Energy by 20. Each time when you do poison damage you have 5% to restore 20 energy. Regain 3% of the total HP per second while the rogue is affected by crowd control effects.`,
      },
    },
  },
  Combat: {
